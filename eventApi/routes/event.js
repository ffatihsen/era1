...
const { getAllEvent, createEvent, updateEvent, deleteEvent, addParticipant, addComment, getEventById,removeParticipant,getJoinedEvent,getCreatedEvent ,shareEventById } = require("../controllers/event");
...
router.post("/:eventId/share",authChech, shareEventById);
